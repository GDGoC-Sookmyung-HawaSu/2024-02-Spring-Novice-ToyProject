...
public class PostsService {
    ...
    public Long update(Long id, PostsUpdateRequestDto requestDto, SessionUser sessionUser) {
        ...
        if (posts.getAuthor().getId().equals(sessionUser.getId())) {
    ...
    public List<PostsListResponseDto> findPostsByUser(String email) {
        return postsRepository.findByAuthorEmail(email)
                .stream()
